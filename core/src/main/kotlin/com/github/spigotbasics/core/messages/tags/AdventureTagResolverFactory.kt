 ...
 */
class AdventureTagResolverFactory(private val facade: SpigotPaperFacade) : TagResolverFactory {

    private val logger = BasicsLoggerFactory.getCoreLogger(AdventureTagResolverFactory::class)
    ...
    override fun createMessageSpecificPlaceholderUnparsed(key: String, value: String): TagResolver {
        return Placeholder.unparsed(MESSAGE_SPECIFIC_TAG_PREFIX + key, value)
    }

    fun createMessageSpecificPlaceholderParsed(key: String, value: String): TagResolver {
        return Placeholder.parsed(MESSAGE_SPECIFIC_TAG_PREFIX + key, value)
    }

    fun createMessageSpecificPlaceholderMessage(key: String, value: Message): TagResolver {

...
internal object GradientNamedPackage : ChatColorPackage {
    ...
    override fun hasPermission(
        ...
        if (permissible.hasPermission(BasicsChatFormatModule.instance.permissionGradientNamed)) {
            return true
        }

        val split = color.split(":")
        for (s in split) {
            if (!NamedColorPackage.hasPermission(permissible, s)) {
                return false
            }
        }
        return true
